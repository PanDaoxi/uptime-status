	...
	var e = {
			...
			463: function (e, t, n) {
							...
							return (
								(n =
									null !== n && void 0 !== n
										? n.concat([e])
										: null),
								$i(4194308, 4, Yi.bind(null, t, e), n)
							);
						},
				...
				function El(e, t, n, r, o) {
					if (null === e) {
						...
						return "function" !== typeof a ||
							...
							? (((e = zs(n.type, null, r, t, t.mode, o)).ref =
									t.ref),
							  (e.return = t),
							  (t.child = e))
				...
				function Nl(e, t, n, r, o) {
					return (
						ha(), ma(o), (t.flags |= 256), kl(e, t, n, r), t.child
					);
				}
				var Rl,
					Dl,
				...
				function us(e) {
					...
					if (1 === n)
						throw ((n = ju), ds(e, 0), ls(e, t), rs(e, Ge()), n);
				...
				function vs(e, t) {
					...
					if ((Sa(), (Ou = n), (_u.current = r), null !== Lu))
						throw Error(a(261));
				...
				function zs(e, t, n, r, o, i) {
					...
					if (((r = e), "function" === typeof e)) Rs(e) && (l = 1);
						...
						e: switch (e) {
							...
							case _:
								return (
									((e = Ns(12, n, t, 2 | o)).elementType = _),
									(e.lanes = i),
									e
								);
							case P:
								return (
									((e = Ns(13, n, t, o)).elementType = P),
									(e.lanes = i),
									e
								);
							case L:
								return (
									((e = Ns(19, n, t, o)).elementType = L),
									(e.lanes = i),
									e
								);
							case D:
	...
	(n.n = function (e) {
		...
		(function () {
			...
			var l = function () {
				...
				return (0, i.jsx)(
					...
					a(
						a({}, e),
						{},
						{ href: e.to, target: "_blank", children: e.text }
					)
				);
			};
			var u = function () {
					...
					(0, i.jsx)("div", {
						...
						children: (0, i.jsxs)("div", {
							...
							children: [
								...
								(0, i.jsx)("div", {
									className: "navi",
									children: window.Config.Navi.map(function (
										e,
										t
									) {
										return (0, i.jsx)(
											l,
											{ to: e.url, text: e.text },
											t
										);
									}),
								}),
			...
			for (var v = [], g = 0; g < 256; ++g)
				v[g] = (g + 256).toString(16).substr(1);
			var y = function (e, t) {
				var n = t || 0,
					r = v;
				return [
					...
					o || t.stopPropagation(),
						n && "true" === a
							...
							: (t.currentTarget.setAttribute(
							  ...
							  R(t.currentTarget, this.getTargetArray(r)),
							  this.showTooltip(t));
				},
				R = function (e, t) {
					for (var n = 0; n < t.length; n++)
			...
			function H(t, n, r, o) {
				...
				if (null === r) return null;
				var a = /<br\s*\/?>/;
				return o && "false" !== o && a.test(t)
					? t.split(a).map(function (t, n) {
			...
			"function" != typeof Te.inspectSource &&
			...
			var Ke,
				...
				Nt = Lt && Lt.v8;
			Nt
				? (Xe = (Ke = Nt.split("."))[0] < 4 ? 1 : Ke[0] + Ke[1])
				: Ot &&
				  (!(Ke = Ot.match(/Edge\/(\d+)/)) || Ke[1] >= 74) &&
				  (Ke = Ot.match(/Chrome\/(\d+)/)) &&
				  (Xe = Ke[1]);
			var Rt,
				Dt = Xe && +Xe,
				zt =
					...
					!J(function () {
						return (
							!String(Symbol()) || (!Symbol.sham && Dt && Dt < 41)
						);
					}),
				...
				$t = function (e, t) {
					...
					return (
						Tt(e) &&
							...
							(n !== Array && !Tt(n.prototype))
								? ce(n) && null === (n = n[Ut]) && (n = void 0)
								: (n = void 0)),
				...
				Qt = Z
					...
					: function (e, t) {
							ke(e);
							for (var n, r = Vt(t), o = r.length, a = 0; o > a; )
								Ee.f(e, (n = r[a++]), t[n]);
							return e;
					  },
			...
			var Jt =
				...
				en = Array.prototype;
			void 0 == en[Zt] &&
				Ee.f(en, Zt, { configurable: !0, value: Jt(null) });
			var tn,
				nn,
				rn,
				on,
						...
						(nn =
							(function (e) {
								(e.prototype.bindWindowEvents = function (e) {
									...
									(e.prototype.unbindWindowEvents =
										function () {
											window.removeEventListener(
												P.HIDE,
												this.globalHide
								...
								(nn =
									(function (e) {
										(e.prototype.isCustomEvent = function (
											e
										) {
											return (
												this.state.event ||
												!!e.getAttribute("data-event")
											);
										}),
											(e.prototype.customBindListener =
												function (e) {
													var t = this,
														n = this.state,
														r = n.event,
											...
											(e.prototype.customUnbindListener =
												function (e) {
													var t = this.state,
														n = t.event,
														r = t.eventOff,
											...
											(function (e) {
												...
												(nn =
													(function (e) {
														...
														(nn =
															(function (e) {
																(e.prototype.isBodyMode =
																	function () {
																		return !!this
																			.props
																			.bodyMode;
																	}),
																	(e.prototype.bindBodyListener =
																		function (
																			e
																		) {
																			var t =
																				...
																				o =
																					n.eventOff,
																				a =
																					n.possibleCustomEvents,
																				i =
																					n.possibleCustomEventsOff,
																				l =
																					M(),
																				u =
																					j(
																...
																((sn = nn =
																	on).prototype.bindRemovalTracker =
																	function () {
																		var e =
																				this,
																			t =
																...
																(nn =
																	void (sn.prototype.unbindRemovalTracker =
																		function () {
																			this
																				.removalTracker &&
			...
			function kn(e) {
				...
				t >= 60 &&
					...
					(t = parseInt(t % 60)),
					n >= 60 &&
						((r = parseInt(n / 60)), (n = parseInt(n % 60))));
				var o = "".concat(t, " \u79d2");
				return (
					n > 0 && (o = "".concat(n, " \u5206 ").concat(o)),
							...
							for (;;)
								switch ((e.prev = e.next)) {
									...
									case 13:
										return e.abrupt(
											"return",
											c.data.monitors.map(function (e) {
												var t =
														e.custom_uptime_ranges.split(
															"-"
														),
													n = wn(t.pop()),
													o = [],
			...
			t.createRoot(document.getElementById("app")).render(
				(0, i.jsx)(_n, {})
			);
		})();
})();
